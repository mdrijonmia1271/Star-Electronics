            ...
            <div class="panel-body" ng-cloak>
                ...
                <table class="table table-bordered" ng-cloak>
                    <tr>
                        ...
                        <th style="cursor:pointer;" ng-click="sortField='category'; reverse = !reverse;">Category
                    ...
                    <tr
                        ...
                        <td class="none">
                            ...
                            ?>
                                ...
                                <a onclick="return confirm('Do you want to delete this Category?');" class="btn btn-danger"
                                    title="Delete"
                                    href="<?php echo site_url('category/category/deleteCategory/{{category.id}}');?>"><i
