            ...
            <div class="panel-body" ng-cloak>
                ...
                <div class="col-md-12">
                    <table class="table table-bordered">
                        ...
                        ?>
                        <tr>
                            <input type="hidden" name="date[]" value="<?php echo $_POST['present_date']; ?>">
                            ...
                            <td width="120">
                                <div class="input-group date control-label pull-left" id="startdatetimepicker<?php echo $key+1; ?>" style="border: 1px solid #ccc; border-radius: 0 5px 5px 0; margin: 3px; padding-top: 0px;">
                                    <input type="text" name="start_time[]" class="form-control" value="<?php echo $value['start_time'];?>">
                                    <span class="input-group-addon">
                            ...
                            <td width="120">
                                <div class="input-group date control-label pull-left" id="enddatetimepicker<?php echo $key+1; ?>" style="border: 1px solid #ccc; border-radius: 0 5px 5px 0; margin: 3px; padding-top: 0px;">
                                    <input type="text" name="end_time[]" class="form-control" value="<?php echo $value['end_time'];?>">
                                    <span class="input-group-addon">
                                        <span class="glyphicon glyphicon-time"></span>
                                    </span>
                                </div>
                            ...
                            <td width="40">
                                <input type="checkbox" name="status[<?php echo $value['emp_id']?>][]" <?php echo ($value['status'] == 'yes')? "checked":"unchecked" ;?> value="yes" class="form-control">
                            </td>
                        </tr>
                        <?php } ?>
                    </table>
