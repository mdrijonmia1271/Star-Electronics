            ...
            <?php   if(checkAuth('super')) { 
                    ...
                    <div class="col-md-3">
                        <select name="search[party_code]"  id="client_dropdown"  class="selectpicker form-control" data-show-subtext="true"
                            ...
                            <option value="" selected >-- Supplier's Name --</option>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left"> Supplier Wise Payment Report </h1>
            ...
            <div class="panel-body">
                ...
                <div class="col-md-12 text-center hide">
                    <h3>Supplier Wise Payment Report</h3>
                </div>
                     ...
                     <?php  
                                ...
                                if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_from']) && ($_POST['month_from'] != '')) &&  (isset($_POST['month_to']) && ($_POST['month_to'] != '')) ){
                                    if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_from']) && ($_POST['month_from'] != ''))){
                                        ...
                                        // last month sale 
                                        $last_month_trnx = get_sum('partytransaction','debit',array('transaction_at >=' => $start,'transaction_at <=' => $end,'trash' => 0,'remark' => 'transaction','party_code' => $row->party_code));
                                    ...
                                    if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_to']) && ($_POST['month_to'] != ''))){
                                        ...
                                        $current_month_trnx = get_sum('partytransaction','debit',array('transaction_at >=' => $start,'transaction_at <=' => $end,'trash' => 0,'remark' => 'transaction','party_code' => $row->party_code));
                                    }
                                }else{
