        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class="pull-left"> Supplier Wise Purchase Report </h1>
                     ...
                     <?php  
                                    ...
                                    if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_from']) && ($_POST['month_from'] != '')) &&  (isset($_POST['month_to']) && ($_POST['month_to'] != '')) ){
                                        if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_from']) && ($_POST['month_from'] != ''))){
                                            ...
                                            // last month sale 
                                            $last_month_sale = get_sum('saprecords','total_bill',array('sap_at >=' => $start,'sap_at <=' => $end,'trash' => 0,'status' => 'purchase','party_code' => $row->party_code));
                                        ...
                                        if((isset($_POST['year']) && ($_POST['year'] != '')) && (isset($_POST['month_to']) && ($_POST['month_to'] != ''))){
                                            ...
                                            $current_month_sale = get_sum('saprecords','total_bill',array('sap_at >=' => $start,'sap_at <=' => $end,'trash' => 0,'status' => 'purchase','party_code' => $row->party_code));
                                        }
                                    }else{
