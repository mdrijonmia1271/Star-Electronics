	...
	<?php echo $this->session->flashdata('confirmation'); ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
	            ...
	            echo form_open('exchange/exchange/newExchange',$attr); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" name="receiveQty"  min="0" class="form-control" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="number" name="givenQty"  min="0" class="form-control" required>
                    </div>
                </div>

                <div class="form-group">
                    <div class="col-md-7">
                        <input type="submit" value="Save" name="sub" class="btn btn-primary pull-right">
                    </div>
                </div>
