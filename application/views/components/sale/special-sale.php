<script src="<?php echo site_url('private/js/ngscript/specialSaleEntry.js')?>"></script>
...
<div class="container-fluid" ng-controller="specialSaleEntry">
  <div class="row">
    <?php echo $confirmation; ?>
    <div class="panel panel-default">
      <div class="panel-heading panal-header">
        <div class="panal-header-title pull-left">
          <h1>Add Special Sale</h1>
        </div>
        <div class="panal-header-title pull-left">
          <p class="hide" style="color: red;font-weight:bold; margin-left: 25px;"><?php echo ($last_voucher)? "Last voucher: ".$last_voucher[0]->voucher_no : " " ;?></p>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="form-group" ng-init="stype='special'" style="display: none;">
            <input type="hidden" name="stype"  ng-model="stype" checked value="special">
          </div>
      ...
      <div class="col-md-6">
        ...
        <div class="form-group">
          ...
          <div class="col-md-8">
            <div class="row">
              <div class="col-md-5">
                <input type="number" name="commission_per" ng-model="amount.discount_percentage" ng-change="calculateDiscountFn()" class="form-control" step="any">
              </div>
              <div class="col-md-7">
                <input type="number" name="total_discount" ng-model="amount.totalDiscount" class="form-control" >
              </div>
            </div>
          </div>
        </div>
