<script src="<?php echo site_url('private/js/ngscript/EditSpecialSaleEntryCtrl.js')?>"></script>
<style>
...
<div class="container-fluid" ng-controller="EditSpecialSaleEntryCtrl">
    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" ng-cloak>
                ...
                echo form_open('sale/specialSaleEdit?vno=' . $this->input->get('vno'), $attr);
                ?>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-8">
                            <div class="row">
                              <div class="col-md-5">
                                <input type="number" name="commission_per" ng-model="amount.commission_percentage" class="form-control" step="any">
                              </div>
                              <div class="col-md-7">
                                <input type="number" name="total_discount" ng-value="calculateDiscountFn()" class="form-control" >
                              </div>
                            </div>
                          </div>
                        </div>
