        ...
        <div class="panel panel-default none">
            ...
            <div class="panel-heading">
                <div class="panal-header-title pull-left">
                    <h1>Search Stock Transfer History</h1>
                </div>
            </div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class=" pull-left">Stock Transfer History
                        <?php 
            ...
            <div class="panel-body">
                ...
                <table class="table table-bordered">
                    <tr>
                        ...
                        <th width="130" class="none">Showroom From</th>
                        <th width="130" class="none">Showroom To</th>
                        <?php } ?>
                    </tr>
                    <?php 
                    ...
                    <tr>
                        ...
                        <?php if(checkAuth('super')) { ?>
                         <td class="none"><?php echo get_name('godowns','name',array('code' => $value->godown_from)); ?></td>
