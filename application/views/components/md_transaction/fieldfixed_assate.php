...
<div class="container-fluid block-hide">
    ...
    echo form_open('md_transaction/fixed_assate/add', $attribute);
    ?>
            ...
            <div class="panel-body no-padding none">
                ...
                <div class="col-md-9">                                
                    <div class="form-group">
                        <label for="" class="col-md-3 control-label">Field of Investor </label>
                        <div class="col-md-7">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td class="none text-center" >                        
                        ...
                        <a title="Delete" class="btn btn-danger" onclick="return confirm('Are you sure want to delete this Field of Fixed Assate?');" href="<?php echo site_url('md_transaction/fixed_assate/delete_field/'.$value->id); ?>" ><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                    </td>
                </tr>
                <?php }} ?>
            </table>
