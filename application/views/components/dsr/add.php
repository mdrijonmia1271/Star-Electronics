	...
	<?php echo $this->session->flashdata('confirmation'); ?>
        <div class="panel panel-default">
            ...
            <div class="panel-body">
	            ...
	            echo form_open('dsr/dsr/addDsr',$attr); ?>


                <div class="form-group">
                    <label class="col-md-3 control-label"> Code <span class="req">*</span></label>
                    <div class="col-md-4">
                        <input type="text" name="code" value="<?php echo generateUniqueId('dsr'); ?>" class="form-control" required readonly>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" name="area" placeholder="" class="form-control" required>
                    </div>
                </div>
