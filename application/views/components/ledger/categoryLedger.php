        ...
        <div class="panel panel-default none">
            ...
            <div class="panel-body" ng-controller="allSaleCtrl" ng-cloak>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-3">
                        <select name="search[godown_code]" id="godown_code"  class="form-control">
                     ...
                     <div class="col-md-3">
                        <select name="search[product_cat]" ng-model="product_group" ng-change="getAllProducts()" class="form-control" >
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panal-header-title">
                    <h1 class=" pull-left">Search Category Ledger (<?php if(!empty($_POST['search']['product_cat'])){ echo $_POST['search']['product_cat']; } ?> )</h1>
...
<script>
    ...
    // Get product list in gorup by
        ...
        $scope.$watch('product_group', function (godown_code){
            var where = {
                table: "stock",
                cond: {
