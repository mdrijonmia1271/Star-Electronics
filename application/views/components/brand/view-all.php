...
<script type="text/javaScript" src="<?php echo site_url('private/js/ngscript/allBrandCtrl.js'); ?>"></script>
...
<div class="container-fluid" ng-controller="allBrandCtrl">
    <div class="row">
	        ...
	        <div class="panel-body"  ng-cloak>
	            ...
	            <table class="table table-bordered">
	                <tr>
	                    ...
	                    <th style="cursor:pointer;" ng-click="sortField='brand'; reverse = !reverse;">Brand &nbsp;<span><i class="fa fa-sort pull-right none" aria-hidden="true"></i></span></th>
	                    <th class="none" style="width: 120px;">Action</th>
	                </tr>

	                <tr dir-paginate="(index,brand) in brands|filter:search|itemsPerPage:perPage|orderBy:sortField:reverse">
	                    <td>{{brand.sl}}</td>
	                    <td>{{brand.brand | removeUnderScore}}</td>
	                    <td  class="none">
                            ...
                            ?>
    	                        <a
    								...
    								title="Edit" href="<?php echo site_url('brand/brand/edit/{{brand.id}}');?>">
    								<i class="fa fa-pencil-square-o" aria-hidden="true"></i>
    							</a>
    
    							<a onclick="return confirm('Do you want to delete this Sub Category?');"
    								class="btn btn-danger" title="Delete"
    								href="<?php echo site_url('brand/brand/delete_brand/{{brand.id}}'); ?>">
