...
class Fixed_assate extends Admin_Controller {
    ...
    public function index() {
        ...
        if($this->input->post('update')){
            ...
            $this->action->update('add_new_md',$data,$where);
            ...
            redirect("md_transaction/fixed_assate","refresh");
        }
        
        $this->data['fixed_asset_filed'] = $this->action->read('add_new_md');
        
        $this->load->view($this->data['privilege'].'/includes/header', $this->data);
        $this->load->view($this->data['privilege'].'/includes/aside', $this->data);
        $this->load->view($this->data['privilege'].'/includes/headermenu', $this->data);
        $this->load->view('components/md_transaction/nav', $this->data);
        $this->load->view('components/md_transaction/fieldfixed_assate', $this->data);
    ...
    public function add(){
        ...
        if($this->action->exists('add_new_md',$data)){
            $this->data['confirmation']=message($this->action->update("add_new_md",$data,$data),$options1);
        }else{
            $this->data['confirmation']=message($this->action->add("add_new_md",$data),$options2);
        }
    ...
    public function newfixed_assate() {
        ...
        $this->data['fixed_assate_fields']=$this->action->readDistinct('add_new_md',"field_fixed_assate");
        ...
        $this->load->view($this->data['privilege'].'/includes/headermenu', $this->data);
        $this->load->view('components/md_transaction/nav', $this->data);
        $this->load->view('components/md_transaction/new', $this->data);
        $this->load->view($this->data['privilege'].'/includes/footer', $this->data);
    }
    ...
    public function add_new_fixed_assate(){
        ...
        $this->session->set_flashdata("confirmation",$this->data['confirmation']);
        redirect("md_transaction/fixed_assate/newfixed_assate","refresh");
    }
    ...
    public function edit($id=NULL) {
        ...
        $this->data['fixed_assate']=$this->action->read('add_new_md',array('id'=>$id));
        $this->data['fixed_assate_fields']=$this->action->readDistinct('add_new_md',"field_fixed_assate");
    ...
    public function update_fixed_assate($id=NULL){
        ...
        $this->session->set_flashdata("confirmation",$this->data['confirmation']);
        redirect("md_transaction/fixed_assate/allfixed_assate","refresh");
    ...
    public function delete_field($id=NULL){
        ...
        $where=array("id"=>$id);
        $this->data['confirmation']=message($this->action->deleteData('add_new_md',$where),$options);
        $this->session->set_flashdata('confirmation',$this->data['confirmation']);
        redirect('md_transaction/fixed_assate','refresh');
    }
     ...
     public function delete_fixed_assate($id=NULL){
        ...
        $this->data['confirmation']=message($this->action->update('add_new_md',$data,$where),$options);
        $this->session->set_flashdata('confirmation',$this->data['confirmation']);
        redirect('md_transaction/fixed_assate','refresh');
    }
