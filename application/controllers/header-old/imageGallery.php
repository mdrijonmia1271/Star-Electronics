...
class ImageGallery extends Admin_Controller {
    ...
    public function index($album = NULL) {
        ...
        $this->data['active'] = 'data-target="gallery"';
...
/*              $config['upload_path'] = './public/gallery';
        ...
        $this->load->view('components/header/gallery_nav', $this->data);
    ...
    public function album($emit = NULL) {
        ...
        $this->load->view($this->data['privilege'].'/includes/headermenu', $this->data);
        $this->load->view('components/header/gallery_nav', $this->data);
        $this->load->view('components/header/img-album', $this->data);
        $this->load->view($this->data['privilege'].'/includes/footer');
    }
    ...
    public function trash($emit = NULL) {
        ...
        //All Delete and restore Start here----------------------------
            ...
            redirect('header/imageGallery/trash','refresh');
                }
            //All restore end
        ...
        $this->load->view($this->data['privilege'].'/includes/headermenu', $this->data);
        $this->load->view('components/header/gallery_nav', $this->data);
        $this->load->view('components/header/gallery_trash', $this->data);
        $this->load->view($this->data['privilege'].'/includes/footer');
    }
